...
<head>
    ...
    <title>แว่นตาขับรถกลางคืน</title>
...
<body style="background-color: #">
    <div class="container" style="align-content: center">
        <div class="head">
            &nbsp;<img src="img2/chart.png" style="width: 25px; height:25px;">&nbsp;แว่นตาขับรถกลางคืน
        </div><br><br>
        <center><img src="img_product/buy_product.png" style="width: 50%;height: 50%;border: 0px solid ;
    border-radius: 10px;
    padding: 5px;" align="center"> </center>
    <div>

    ราคาใบสั่ง<input type="text" id="number2" value="690" style="border:0px; width: 30%;border:3px;border-color: red;color:red;font-size: 30px;text-align: center;" name="cus_price" />บาท<br><br><form id="demo1" class="demo" style="display:none;" autocomplete="off" uk-grid action="page3.php" method="post">
...
<script>
	fbq('track', 'livingbigsale_glasses_page2');
</script>
