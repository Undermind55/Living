...
<body>
  <div class="container">
	<br><br><br>
	<center><img src="img2/congrate.png" alt=""><br>
		<div style="width: 50%;height: 90px;background-color: red;color:white;font-size: 25px;border-radius: 20px;"><p><br>รายการสำเร็จ</p></div><br><br>
...
<script>
	fbq('track', 'livingbigsale_glasses_page4');
</script>