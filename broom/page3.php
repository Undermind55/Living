...
$sql = "INSERT INTO `customer` (`cus_id`, `cus_name`, `cus_tel`, `cus_address`, `cus_provice`, `cus_amphoe`, `cus_tumbon`, `cus_zip`, `cus_price`, `cus_comment`,`type`,`date`) VALUES (NULL, '$cus_name', '$cus_tel', '$cus_address', '$cus_provice', '$cus_amphoe', '$cus_tumbon', '$cus_zipcode', '$cus_real_price', '$cus_comment','bug','$datetime');";
...
<script>
	fbq('track', 'livingbigsale_bug_page3');
</script>